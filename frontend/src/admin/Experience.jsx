...
export default function Experience() {
  ...
  const handleSubmit = async () => {
    const res = await fetch(
      editId ? `${API_BASE}/experience/${editId}` : `${API_BASE}/experience`,
      {
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {data.map((e) => (
          <div key={e._id} className="bg-gray-900 p-5 rounded-xl border border-gray-800 relative flex gap-4">
            ...
            {/* Logo */}
            <img
              src={e.logo || "https://via.placeholder.com/50"}
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-400">{e.role}</p>
              ...
              <p className="text-sm mt-2 text-gray-300">{e.desc}</p>
            </div>
      ...
      {open && (
        <div className="fixed inset-0 bg-black/70 flex justify-center items-center">
          <div className="bg-white text-black p-6 rounded-xl w-full max-w-md">
            ...
            <h2 className="font-bold mb-4">{editId ? "Edit" : "Add"} Experience</h2>
            ...
            <div className="space-y-3">
              ...
              <input name="period" value={form.period} onChange={handleChange} placeholder="2022 - Present" className="input" />
